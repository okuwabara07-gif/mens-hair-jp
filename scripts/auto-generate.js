...
const SITE_NAME = 'メンズヘアJP';
const TOPIC = 'メンズヘアケア・スタイリング・育毛';
const CRITERIA = '効果・使いやすさ・コスパ・香り・成分';
const A8_PRODUCT_NAME = 'ビューティーパーク';
const A8_PRODUCT_URL = 'https://px.a8.net/svt/ejp?a8mat=4AZR8U+GDF5O2+3HS2+UVBPU';
const A8_PRODUCT_DESC = '美容商品の総合通販サイト';
